...
#calculos de preco:
preco_mensal_ticket_unico_cartao = "{:.2f}".format(tickets_unicos_cartao_soma * dias)

preco_mensal_ticket_unico_compass = "{:.2f}".format(tickets_unicos_compass_soma * dias)
...
print("O valor do ticket unico com cartao de credito ou debito no periodo de um mes sera de ${}".format(preco_mensal_ticket_unico_cartao))
print("O valor do ticket unico com o cartao compass no periodo de um mes sera de ${}".format(preco_mensal_ticket_unico_compass))
print("O valor do ticket 'All Day' no periodo de um mes sera de ${}".format(preco_mensal_ticket_dia_todas_as_zonas))
print("O valor do ticket mensal das duas zonas no periodo de um mes sera de ${}".format(preco_mensal_ticket_mes))
